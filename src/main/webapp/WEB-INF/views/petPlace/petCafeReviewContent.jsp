	...
	<div class="inner">
		<div class="cafeInfoSec">
			...
			<section class="infoSec">
				...
				<c:if test="${res == 0}"><p>방문자후기 0 • 찜 <button onclick="wishPickBtn(${cafeVO.idx})"><img src="${ctp}/resources/images/icon/love-3.png" style="width:30px;"/></button></p></c:if>
				<c:if test="${res != 0}"><p>방문자후기 0 • 찜 <button onclick="wishDeleteBtn(${cafeVO.idx})"><img src="${ctp}/resources/images/icon/love.png" style="width:30px;"/></button></p></c:if>
				<hr/>
