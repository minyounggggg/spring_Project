...
insert into petCafeReview values (default,819,'cmy1234','민영9','noimage.png','커피도 디저트도 다 맛있어요','분위기도 전체적으로 밝은 분위기였고 개방적이여서 강아지들이 뛰어놀기 좋아요.','noimage.png','noimage123.png','OK',default,default,default,default,'192.168.50.53');
insert into petCafeReview values (default,819,'minmin0325','최민영','noimage.png','별로였어요','분위기도 Ewwww 밝은 분위기 Ewwwww 개방적이여서 Ewwwwwwwwww','noimage.png','noimage123.png','NO',default,default,default,default,'192.168.50.53');
